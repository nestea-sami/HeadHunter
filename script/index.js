...
//   item.classList.add('found__item');

//   item.insertAdjacentHTML('afterbegin', `
//     <h1 class="found">${amount}&laquo;<span class="found__item">${foundVacancy}</span>&raquo;</h1>
//   `);
...
formSearch.addEventListener('submit', async (e) => {
  ...
  if (textSearch.length > 2) {
    ...
    renderCards(data);
    formSearch.reset();
    h1.innerHTML = `${data.length} вакансий &laquo; ${textSearch}&raquo;`;
  } else {
